...
python main.py --n_model 'CNN' --n_data 'CIFAR-10' --batch_size_test 1024 --num_epochs 10 --flag_myaug_training 1 --flag_dropout 0 --layer_aug 0 --layer_drop 0 --flag_random_layer 1 --n_aug 3 --flag_var 0 --flag_als 1 --als_rate 0.001 --epoch_random 5 --gpu_multi 0 --loop 0
