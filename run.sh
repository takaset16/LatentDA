...
python main.py --n_model 'CNN' --n_data 'CIFAR-10' --num_epochs 2 --n_aug 6 --flag_als 5 --als_rate 0.1 --flag_sign 1 --iter_interval 100 --flag_adversarial 1 --flag_wandb 0 --gpu_multi 0 --loop 0
