...
python main.py --n_model 'CNN' --n_data 'CIFAR-10' --num_epochs 5 --flag_myaug_training 1 --flag_random_layer 1 --n_aug 5 --flag_als 3 --flag_adversarial 0 --iter_interval 500 --gpu_multi 0 --loop 0
